...
CREATE TABLE IF NOT EXISTS portfolio_assets (
    ...
    unrealized_pl VARCHAR(255) NOT NULL,
    unrealized_pl_percent VARCHAR(255) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS budgets (
    id INT AUTO_INCREMENT PRIMARY KEY,
    user_id INT NOT NULL,
    monthly_budget VARCHAR(255) NOT NULL,
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES users(id) ON DELETE CASCADE,
...
(3, 'Birthday Party', '2024-02-15', '2024-02-16', 500.00),
(3, 'Vacation', '2024-03-01', '2024-03-10', 2000.00),
(3, 'Home Renovation', '2024-04-10', '2024-04-20', 1500.00);
