...
def validate_category(category):
    ...
    valid_categories = ['Food', 'Transportation', 'Entertainment', 'Bills', 'Shopping', 'Healthcare', 'Education', 'Salary', 'Freelance', 'Bonus', 'Investments', 'Other']
...
def validate_asset(name, asset_type, value, quantity):
    ...
    if asset_type not in ['Stock', 'Bond', 'ETF', 'Crypto', 'Real Estate', 'Cash', 'Other']:
